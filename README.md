## AWS CloudFormation Resource Provider Package For AWS SES MailManager

This repository contains AWS-owned resource providers for the `AWS::SES::MailManager*` namespace.
