...
public class TagHelper {
     ...
     */
    public static Map<String, String> convertToMapFromResource(final Collection<software.amazon.ses.mailmanageraddoninstance.Tag> tags) {
        ...
        return tags.stream()
                ...
                .collect(Collectors.toMap(
                        software.amazon.ses.mailmanageraddoninstance.Tag::getKey,
                        software.amazon.ses.mailmanageraddoninstance.Tag::getValue,
