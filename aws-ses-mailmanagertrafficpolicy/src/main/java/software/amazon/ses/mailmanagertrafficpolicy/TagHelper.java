...
public class TagHelper {
     ...
     */
    public static Map<String, String> convertToMapFromResource(final Collection<software.amazon.ses.mailmanagertrafficpolicy.Tag> tags) {
        ...
        return tags.stream()
                ...
                .collect(Collectors.toMap(
                        software.amazon.ses.mailmanagertrafficpolicy.Tag::getKey,
                        software.amazon.ses.mailmanagertrafficpolicy.Tag::getValue,
