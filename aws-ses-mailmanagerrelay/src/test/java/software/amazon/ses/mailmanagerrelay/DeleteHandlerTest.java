...
import static software.amazon.ses.mailmanagerrelay.HandlerHelper.fakeDeleteRelayResponse;
...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handle_request_simple_success() {
        ...
        when(mailManagerClient.deleteRelay(any(DeleteRelayRequest.class))).thenReturn(fakeDeleteRelayResponse());
