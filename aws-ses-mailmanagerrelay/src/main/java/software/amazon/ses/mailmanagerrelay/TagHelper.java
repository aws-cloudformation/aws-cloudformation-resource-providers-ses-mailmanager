...
public class TagHelper {
     ...
     */
    public static Map<String, String> convertToMapFromResource(final Collection<software.amazon.ses.mailmanagerrelay.Tag> tags) {
        ...
        return tags.stream()
                ...
                .collect(Collectors.toMap(
                        software.amazon.ses.mailmanagerrelay.Tag::getKey,
                        software.amazon.ses.mailmanagerrelay.Tag::getValue,
