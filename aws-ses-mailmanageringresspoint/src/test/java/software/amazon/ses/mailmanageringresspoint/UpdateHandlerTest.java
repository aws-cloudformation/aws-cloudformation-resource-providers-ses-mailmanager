...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    @Test
    @Tag("SkipTearDown")
    public void handleRequest_failure_due_to_updating_open_relay_with_unneeded_config() {
        final UpdateHandler handler = new UpdateHandler();

        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(auth_relay_model)
    ...
    @Test
    @Tag("SkipTearDown")
    public void handleRequest_failure_due_to_update_create_only_parameter() {
        final UpdateHandler handler = new UpdateHandler();

        final ResourceModel open_relay_to_update = ResourceModel.builder()
                .ingressPointName("new name")
                .build();

        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(open_relay_to_update)
                .previousResourceState(open_relay_model)
                .clientRequestToken(HandlerHelper.CLIENT_REQUEST_TOKEN)
                .build();
