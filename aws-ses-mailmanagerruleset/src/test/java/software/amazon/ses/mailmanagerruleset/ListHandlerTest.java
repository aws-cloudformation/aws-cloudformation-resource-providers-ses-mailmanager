...
import static software.amazon.ses.mailmanagerruleset.HandlerHelper.fakeListRuleSetsResponse;
...
public class ListHandlerTest extends AbstractTestBase{
    ...
    public void handle_request_simple_success() {
        ...
        when(mailManagerClient.listRuleSets(any(ListRuleSetsRequest.class))).thenReturn(fakeListRuleSetsResponse());
