...
import static software.amazon.ses.mailmanagerarchive.HandlerHelper.fakeDeleteArchiveResponse;
...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    @Test
    public void handle_delete_request_simple_success() {
        ...
        when(mailManagerClient.getArchive(any(GetArchiveRequest.class))).thenReturn(fakeGetArchiveResponse()).thenReturn(fakeGetDeletedArchiveResponse());
        when(mailManagerClient.deleteArchive(any(DeleteArchiveRequest.class))).thenReturn(fakeDeleteArchiveResponse());
    ...
    @Test
    public void handle_delete_request_failure_due_to_not_exist() {
        final DeleteHandler handler = new DeleteHandler();
